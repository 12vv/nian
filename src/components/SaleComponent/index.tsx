...
const SaleComponent = (props: any) => {
  ...
  useEffect(() => {
    // const data2 = [
    //   ["孜然羊排炒饭", { 星期一: [0.741, 19, 0], 星期二: [0.741, 19, 0] }],
    //   ["咖喱牛腩饭", { 星期一: [0.741, 19, 0], 星期二: [0.741, 19, 0] }],
    //   ["虾仁牛肉炒饭", { 星期一: [0.741, 19, 0], 星期二: [0.741, 19, 0] }],
    //   ["酸菜肥肠饭", { 星期一: [0.741, 19, 0], 星期二: [0.741, 19, 0] }],
    // ] as any;
  ...
  const getRecommend = async (params: any) => {
    ...
    try {
      const res = await axios.post(`${basePath}${url}`, {}, { params: params });
